...
*/
$baseUrl = 'http://dev.noralatorre.com/inc/ckfinder/files/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = '/var/www/vhosts/noralatorre.com/subdomains/dev/httpdocs/inc/ckfinder/files/';//resolveUrl($baseUrl);
